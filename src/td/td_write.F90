...
contains
  ...
  !----------------------------------------------------------
  subroutine td_write_mxll_free_data(writ, namespace, space, gr, st, hm, helmholtz, outp, clock)
    type(td_write_t),                intent(inout) :: writ
    type(namespace_t),               intent(in)    :: namespace
    type(space_t),                   intent(in)    :: space
    type(grid_t),                    intent(inout) :: gr
    ...
    call output_mxll(outp, namespace, space, gr, st, hm, helmholtz, clock%time(), filename)
