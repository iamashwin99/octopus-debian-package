/*
 Copyright (C) 2016 M. Marques, A. Castro, A. Rubio, G. Bertsch, M. Oliveira, X.
Andrade
...
/* Interpolation */
extern "C" void FC_FUNC_(oct_spline_end, OCT_SPLINE_END)(void **spl,
                                                         void **acc) {
  gsl_spline_free((gsl_spline *)(*spl));
  gsl_interp_accel_free((gsl_interp_accel *)(*acc));
}

extern "C" void FC_FUNC_(oct_spline_fit,
                         OCT_SPLINE_FIT)(const fint *nrc, const double *x,
                                         const double *y, void **spl,
                                         void **acc) {
...
extern "C" double FC_FUNC_(oct_spline_eval, OCT_SPLINE_EVAL)(const double *x,
                                                             const void **spl,
                                                             void **acc) {
...
void oct_spline_eval_array(fint nn, Type *xf, const void **spl, void **acc) {
  for (fint ii = 0; ii < nn; ii++) {
    xf[stride * ii] = Type(gsl_spline_eval(
        (gsl_spline *)(*spl), xf[stride * ii], (gsl_interp_accel *)(*acc)));
  }
}

extern "C" void FC_FUNC_(oct_spline_eval_array,
                         OCT_SPLINE_EVAL_ARRAY)(const fint *nn, double *xf,
 ...
 */
extern "C" void FC_FUNC_(oct_spline_eval_arrayz,
                         OCT_SPLINE_EVAL_ARRAYZ)(const fint *nn, double *xf,
                                                 const void **spl, void **acc) {
...
extern "C" fint FC_FUNC_(oct_spline_npoints,
                         OCT_SPLINE_NPOINTS)(const void **spl, void **acc) {
  return (fint)((gsl_spline *)(*spl))->size;
}

/* This function places in the x array the x values of a given spline spl*/
extern "C" void FC_FUNC_(oct_spline_x, OCT_SPLINE_X)(const void **spl,
                                                     void **acc, double *x) {
...
extern "C" void FC_FUNC_(oct_spline_y, OCT_SPLINE_Y)(const void **spl,
                                                     void **acc, double *y) {
  int size, i;
...
extern "C" double FC_FUNC_(oct_spline_eval_integ,
                           OCT_SPLINE_EVAL_INTEG)(const void **spl,
                                                  const double *a,
                                                  const double *b, void **acc) {
  /* the GSL headers specify double a, double b */
  return gsl_spline_eval_integ((gsl_spline *)(*spl), *a, *b,
                               (gsl_interp_accel *)(*acc));
}

extern "C" double FC_FUNC_(oct_spline_eval_integ_full,
                           OCT_SPLINE_EVAL_INTEG_FULL)(const void **spl,
                                                       void **acc) {
  /* the GSL headers specify double a, double b */
...
extern "C" double FC_FUNC_(oct_spline_eval_der,
                           OCT_SPLINE_EVAL_DER)(const double *x,
                                                const void **spl, void **acc) {
  /* the GSL headers specify double x */
  return gsl_spline_eval_deriv((gsl_spline *)(*spl), *x,
                               (gsl_interp_accel *)(*acc));
}

/* Performs the second derivative of a spline */
extern "C" double FC_FUNC_(oct_spline_eval_der2,
                           OCT_SPLINE_EVAL_DER2)(const double *x,
                                                 const void **spl, void **acc) {
  /* the GSL headers specify double x */
  return gsl_spline_eval_deriv2((gsl_spline *)(*spl), *x,
                                (gsl_interp_accel *)(*acc));
}
