...
void FC_FUNC(dscal, DSCAL)(const fint *n, const double *a, const double *x,
                           const fint *incx);
void FC_FUNC(daxpy, DAXPY)(const fint *n, const double *a, const double *x,
                           const fint *incx, double *y, const fint *incy);

/* interface to apply blas with a real constant over complex vectors */

void FC_FUNC(dazscal, DAZSCAL)(const fint *n, const double *restrict a,
                               double *restrict x) {
...
void FC_FUNC(dazaxpy, DAZAXPY)(const fint *n, const double *restrict a,
...
void FC_FUNC(dgemm, DGEMM)(const char *transa, const char *transb,
                           ...
                           const fint *lda, const double *b, const fint *ldb,
...
void FC_FUNC(zdgemm, ZDGEMM)(const char *transa, const char *transb,
                             const fint *m, const fint *n, const fint *k,
                             const double *alpha, const double *restrict a,
                             const fint *lda, const double *restrict b,
                             const fint *ldb, const double *beta,
