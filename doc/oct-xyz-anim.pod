...
oct-xyz-anim - Constructs an "animated" xyz file
...
[oct-xyz-anim does not read the standard input: all standard
input will be simply ignored. An input file named F<inp> must be
present in the running directory.  Also, oct-xyz-anim accepts
...
(WARNING: MISSING SHORT DESCRIPTION OF THE PROGRAM)
